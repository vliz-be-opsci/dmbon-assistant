...
class Profile(RoCrateGitBase):
    ...
    """
    def __init__(self, repo_url, name, description, logo_url=None, uuid= None, seed_dependencies= None, parent_space= None):
        """ 
        ...
        :param parent_space: Optional - parent space of the profile
        :type parent_space: str
        """  
        self.uuid = uuid
        self.name = name
    ...
    identity_props = ["repo_url","logo_url","description","uuid","seed_dependencies","parent_space"]
    ...
    def as_dict(self):
        ...
        return dict(name=self.name,
                    ...
                    parent_space = self.parent_space #todo use set instead of list
                )
