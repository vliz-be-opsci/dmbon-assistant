                        ...
                        <Navbar expand="lg" className='bluebar'>
                            <Container>
                                ...
                                <Nav className="me-auto justify-content-center">
                                    ...
                                    <Nav.Link href= {`/spaces/${spaceid}/files`}><p className='bluebar_button'><FaFolderOpen size="1.5em"/></p></Nav.Link>
                                    <Nav.Link href= {`/spaces/${spaceid}/git`}><p className='bluebar_button activito'><FaGitAlt size="1.5em"/></p></Nav.Link>
                                </Nav>
                                <Nav className="justify-content-end">
                                    <Nav.Link href= {`/spaces/${spaceid}/settings`}><p className='bluebar_button'><FaCog size="1.5em"/></p></Nav.Link>
                                </Nav>
                                </Navbar.Collapse>
                            </Container>
                        </Navbar>
                    ...
                    <div className="container">
                        <Navbar expand="lg" className='bluebar'>
                            <Container>
                                ...
                                <Nav className="me-auto justify-content-center">
                                    <Nav.Link href= {`/spaces/${spaceid}/`}><p className='bluebar_button'>{Spacename}</p></Nav.Link>
                                    <Nav.Link href= {`/spaces/${spaceid}/files`}><p className='bluebar_button activito'><FaFolderOpen size="1.5em"/></p></Nav.Link>
                                    <Nav.Link href= {`/spaces/${spaceid}/git`}><p className='bluebar_button'><FaGitAlt size="1.5em"/></p></Nav.Link>
                                </Nav>
                                <Nav className="justify-content-end">
                                    <Nav.Link href= {`/spaces/${spaceid}/settings`}><p className='bluebar_button'><FaCog size="1.5em"/></p></Nav.Link>
                                </Nav>
                    ...
                    <div className="container">
                        <Navbar expand="lg" className='bluebar'>
                            <Container>
                                ...
                                <Nav className="justify-content-end">
                                    <Nav.Link href= {`/spaces/${spaceid}/settings`}><p className='bluebar_button activito'><FaCog size="1.5em"/></p></Nav.Link>
                                </Nav>
                                </Navbar.Collapse>
                            </Container>
                        </Navbar>
